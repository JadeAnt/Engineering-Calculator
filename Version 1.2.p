import math
# Python Engineering Calculator Ver 1.2- Adjustments for in shell coding.
...
print('I = sqrt P / R')
print('I = sqrt', str(P), 'Watts', '/', str(R), 'Ohms', '=', str(Ampere3), 'A')
print()
...
print('E = sqrt P * R')
print('E = sqrt', str(P), 'Watts', '*', str(R), 'Ohms', '=', str(Voltage2), 'V')
print()
Voltage3 = P / I
print('E = P / I')
